...
|---|---|---|---|---|---|---|---|---|---|
| 2026-09-05 | [Galaxy Z Flip6](tests/2026-09-05-galaxy-z-flip6.md) | _TODO_ | rndis_host | 2.0 | bbr | 102 / 121 / 113 | 232 | 23.0 ms | good |
...
- [ ] **USB 3 cable - the highest-value test in this repo.** Three
      SuperSpeed-capable phones from two vendors (2x Pixel 9a, Galaxy Z Flip6)
      all enumerate at 480, aggregate has reached 91% of the USB 2.0 ceiling,
      and no device on this host has ever trained SuperSpeed on any bus. The
      phone is ruled out; suspicion now leans toward the host port over the
      cable, but one pass with a known-good USB 3 cable settles it.
