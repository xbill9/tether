...
- [ ] **Try a cable of known SuperSpeed rating - one more cable eliminated,
      the question still open.** The iPhone 17 Pro advertises SuperSpeedPlus at
      10 Gb/s and has now enumerated at 480 in **two physical ports** (`3-2`,
      `3-1`) across **two different C-to-C cables**, on a host whose `usb2`
      (20 Gb/s) and `usb4` (10 Gb/s) root hubs are working and idle
      ([record](tests/2026-09-05-iphone-17-pro-att-cable2.md)). That rules out
      the first cable specifically, but **neither cable is verifiably wired for
      SuperSpeed**, and two USB 2.0 cables produce exactly this result. Only a
      cable rated 5 or 10 Gb/s settles it.
...
- [ ] **Re-run the AT&T Pixel 9a to test whether AT&T degraded this afternoon.**
      The iPhone 17 Pro dropped from 178 to 85 Mbps aggregate and 38.0 to 54.2 ms
      RTT between 12:40 and 13:19 on the same cell, same host, zero USB errors
      ([record](tests/2026-09-05-iphone-17-pro-att-cable2-settled.md)). The Pixel
      reached 273 aggregate on AT&T earlier the same day, so re-running it now
      says whether this is carrier-wide or specific to the iPhone.
