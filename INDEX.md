...
- [ ] **USB 3 cable - now the highest-value test in this repo.** Two separate
      Pixel 9a units, on two carriers, both advertise SuperSpeed
      (`wSpeedsSupported 0x000f`) and both enumerate at 480, with aggregate
      now at 91% of the USB 2.0 ceiling. The phone is ruled out; cable vs host
      port is not. No device on this host has ever trained SuperSpeed.
